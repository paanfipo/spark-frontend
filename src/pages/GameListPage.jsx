...
function GameListPage() {
  ...
  const IMAGE_MAP = {
    'matriz-de-memoria': '/portada/MatrizdeMemoria.png',
    'sigue-la-secuencia': '/portada/SigueLaSecuencia.png',
    'recuerda-los-objetos': '/portada/RecuerdaLosObjetos.png',
    'caja-de-recuerdos': '/portada/CajaDeRecuerdos.png',
    'deja-vu': '/portada/DejaVu.png',
    'ruta-de-luces': '/portada/RutaDeLuces.png',
    'ruta-de-colores-al-reves': '/portada/RutaDeColoresAlReves.png',
    'concentrate-en-el-objetivo': '/portada/ConcetranteEnElObjetivo.png',
    'cazador-de-burbujas': '/portada/CazadorDeBurbujas.png',
    'enfoca-la-flecha': '/portada/EnfocaLaFlecha.png',
    'no-te-despistes': '/portada/NoTeDespistes.png',
    'safari-fotografico': '/portada/SafariFotografico.png',
    'sopa-de-letras': '/portada/SopaDeLetras.png',
    'comparacion-de-colores': '/portada/ComparacionDeColores.png',
    'tormenta-de-palabras': '/portada/TormentaDePalabras.png',
    'el-lector-del-cosmos': '/portada/LectorDeCosmos.png',
    'a-fin': '/portada/Afin.png',
    'que-sentido-tiene': '/portada/QueSentidoTiene.png',
    'apunta-y-acierta': '/portada/ApuntaYAcierta.png',
    'construye-la-caneria': '/portada/ConstruyeLaCaneria.png',
    'colorea-el-camino': '/portada/ColoreaElCamino.png',
    'mosaico-espejo': '/portada/MosaicoEspejo.png',
    'trazos-conectados': '/portada/TrazosConectados.png',
    'enfoque-cambiante': '/portada/EnfoqueCambiante.png',
    'hojas-navegantes': '/portada/HojasNavegantes.png',
    'balance-de-balanza': '/portada/BalanceDeBalanza.png',
    'matrices-progresivas': '/portada/MatricesProgresivas.png',
